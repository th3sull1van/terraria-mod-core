...
| **Vanilla Game** | **Terraria 1.4.5.7** | Steam or GOG release | Located typically at `D:\Jogos\Steam\steamapps\common\Terraria` or `C:\Program Files (x86)\Steam\steamapps\common\Terraria`. |
