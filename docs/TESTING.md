...
TMC includes a standalone test suite (`TerrariaModCore.Tests.exe`) that executes **391 comprehensive assertions** covering core infrastructure, isolated plugin behaviors, and multi-mod coexistence scenarios.
