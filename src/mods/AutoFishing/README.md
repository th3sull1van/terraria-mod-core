...
- **User-Initiated Lifecycle (Manual Start & Stop)**:
...
- **Configurable Natural Reaction Timers**:
...
Located at `mods/AutoFishing/config.json`:
...
| `AutoReel` | `bool` | `true` | Automatically reels in when a fish or item bites. |
